...
import DEFAULT_TOKEN_LIST from '../../config/constants/tokenLists/eldenfi-default.tokenlist.json'
import UNSUPPORTED_TOKEN_LIST from '../../config/constants/tokenLists/eldenfi-unsupported.tokenlist.json'
import WARNING_TOKEN_LIST from '../../config/constants/tokenLists/eldenfi-warning.tokenlist.json'
import ONRAMP_TOKEN_LIST from '../../config/constants/tokenLists/eldenfi-supported-onramp-currency-list.json'
