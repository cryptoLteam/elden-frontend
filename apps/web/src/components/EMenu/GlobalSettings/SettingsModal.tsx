    ...
    >
      ...
      >
        <AtomBox>
          ...
          <Flex justifyContent="space-between" alignItems="center" mb="24px">
            ...
            <Toggle
              ...
              startIcon={(isActive = false) => {
                return isActive ? <img src="/efi/toggle.png" width={28} height={28} alt="icon" /> : <></>
              }}
          ...
          <Flex justifyContent="space-between" alignItems="center" mb="24px">
            <Flex alignItems="center">
              <Text>EldenFi {t('StableSwap')}</Text>
              {/* <QuestionHelper
                text={
                  <Flex flexDirection="column">
                    <Text mr="5px">
          ...
          {/* <Flex justifyContent="space-between" alignItems="center" mb="24px">
            <Flex alignItems="center">
              <Text>{`EldenFi ${t('MM Linked Pool')}`}</Text>
            </Flex>
            <Toggle
