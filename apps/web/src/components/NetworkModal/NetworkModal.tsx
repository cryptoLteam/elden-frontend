...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_BASE }: { pageSupportedChains?: number[] }) => {
  ...
  const isScrollOnlyPage = useMemo(() => {
    return (
      ...
      (pageSupportedChains[0] === ChainId.BASE || pageSupportedChains[0] === ChainId.BASE_TESTNET)
    )
  }, [pageSupportedChains])
