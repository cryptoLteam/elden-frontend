...
import { getNftPoolAddress, useNftFactoryContract, usePositionHelperContract } from 'utils/eldenUtils'
import { maxAmountSpend } from 'utils/maxAmountSpend'
import { SettingsMode } from 'components/EMenu/GlobalSettings/types'
import { POSITION_HELPER_ADDRESS } from 'config/constants/elden'
...
import ConfirmAddESNftLiquidityModal from './components/ConfirmAddESNftLiquidityModal'

export interface ESNftLPChildrenProps {
  error: string
  currencies: {
...
export default function AddESNftLiquidity({
  currencyA,
  currencyB,
  children,
}: {
  currencyA: Currency
  currencyB: Currency
  children: (props: ESNftLPChildrenProps) => ReactElement
}) {
