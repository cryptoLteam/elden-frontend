      ...
      <DetailBox>
        <Flex>
          <DetailCard>
            ...
            <span>${formatAmount(sEldenPrice)}/sELDEN</span>
          </DetailCard>
          <DetailCard>
        ...
        <p style={{ color: 'gray' }}>
          ...
          accessible by whitelisted participants. In addition to PROJECTNAME's own whitelist, sELDEN holders who
        ...
        <p style={{ color: 'gray' }}>
          <p>
            1. sELDEN allocators will receive a guaranteed share of those $600,000 allocations during the first stage
            (12h duration), with the whitelisted amount proportional to the total amount of sELDEN allocated, capped to
            $5k/wallet.
          </p>
          <p>
        ...
        <p style={{ color: 'gray' }}>
          Since an individuals' whitelist allocation is proportional to the total amount of sELDEN allocated to the
