  ...
  return (
    <Page>
      ...
      <Flex style={{ gap: 12 }} my={20}>
        <EButtonSm style={{ width: '120px' }} onClick={() => setListType(0)} isActive={listType === 0}>
          Top Tokens
        </EButtonSm>
        <EButtonSm style={{ width: '120px' }} onClick={() => setListType(1)} isActive={listType === 1}>
          Top Pairs
        </EButtonSm>
        <EButtonSm style={{ width: '120px' }} onClick={() => setListType(2)} isActive={listType === 2}>
          Transactions
        </EButtonSm>
      </Flex>
