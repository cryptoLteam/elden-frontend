...
const NotOkNFT = ({ admissionProfile }) => {
  ...
  return (
    <TransWithElement
      ...
      element={
        <>
          <LinkExternal style={{ display: 'inline' }} href={`https://elden.fi/nfts/collections/${admissionProfile}`}>
            {t('Pancake Squad NFT')}
          </LinkExternal>
          <br />
        </>
  ...
  return (
    <TransWithElement
      ...
      element={
        <>
          <br />
          <LinkExternal style={{ display: 'inline' }} href={`https://elden.fi/profile/${account}/achievements/`}>
            {t('Pancake Profile')}
          </LinkExternal>
        </>
      }
