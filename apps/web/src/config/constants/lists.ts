...
export const PANCAKE_EXTENDED = 'https://tokens.elden.fi/pancakeswap-extended.json'

const COINGECKO = 'https://tokens.elden.fi/coingecko.json'
const PANCAKE_ETH_DEFAULT = 'https://tokens.elden.fi/pancakeswap-eth-default.json'
const PANCAKE_ZKSYNC_DEFAULT = 'https://tokens.elden.fi/pancakeswap-zksync-default.json'
const PANCAKE_POLYGON_ZKEVM_DEFAULT = 'https://tokens.elden.fi/pancakeswap-polygon-zkevm-default.json'
const PANCAKE_ARB_DEFAULT = 'https://tokens.elden.fi/pancakeswap-arbitrum-default.json'
const PANCAKE_LINEA_DEFAULT = 'https://tokens.elden.fi/pancakeswap-linea-default.json'
const PANCAKE_BASE_DEFAULT = 'https://tokens.elden.fi/pancakeswap-base-default.json'
const PANCAKE_OPBNB_DEFAULT = 'https://tokens.elden.fi/pancakeswap-opbnb-default.json'

export const PANCAKE_ETH_MM = 'https://tokens.elden.fi/pancakeswap-eth-mm.json'
export const PANCAKE_BSC_MM = 'https://tokens.elden.fi/pancakeswap-bnb-mm.json'

const COINGECKO_ETH = 'https://tokens.coingecko.com/uniswap/all.json'
// export const CMC = 'https://tokens.elden.fi/cmc.json' // not updated for a while
